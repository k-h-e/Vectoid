...
- (BOOL)application: (UIApplication *)application didFinishLaunchingWithOptions: (NSDictionary *)launchOptions {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[[KXMViewController alloc] initWithNibName: @"KXMViewController_iPhone" bundle: nil]
                                  autorelease];
    }
    else {
        self.viewController = [[[KXMViewController alloc] initWithNibName: @"KXMViewController_iPad" bundle: nil]
                                  autorelease];
    }
