...
#ifndef KXM_ZARCH_VIDEO_NEWVIDEO_H_
#define KXM_ZARCH_VIDEO_NEWVIDEO_H_
...
class NewVideo : public virtual Game::EventHandlerInterface {
  public:
    ...
    NewVideo(boost::shared_ptr<Game::Processes<ZarchProcess::ProcessType> > processes);
...
#endif    // KXM_ZARCH_VIDEO_NEWVIDEO_H_
