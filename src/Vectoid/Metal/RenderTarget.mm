...
shared_ptr<Vectoid::TextConsole> RenderTarget::NewTextConsole(
    ...
    return std::make_shared<TextConsole>(context_, width, height, glyphWidth, glyphHeight, glyphs);
}
